...
function Component3() {
  return (
    <div className="h-[60px] relative shrink-0 w-full" data-name="32">
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[56px] leading-[30px] left-0 text-[18px] text-black top-[2px] w-[551px]">Descubre nuestra nueva línea de ropa personalizada para mascotas. En Mundo Polar, tu engreído disfrutará el invierno con comodidad y estilo.</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="[word-break:break-word] font-['Jost:Regular',sans-serif] font-normal h-[164px] leading-[70px] relative shrink-0 text-[58px] text-black w-full">Personaliza el abrigo de tu mascota con Mundo Polar</p>
      <Component3 />
    </div>
  );
}
...
function Component31() {
  return (
    <button className="h-[44px] relative rounded-[5px] shrink-0 w-[153px] border-0 bg-transparent cursor-pointer p-0" data-name="687" onClick={() => navigateTo("contacto")}>
      <div aria-hidden className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[5px]" />
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[42px] left-[15px] text-[16px] text-black top-0 w-[131px]">Personalizar ahora</p>
    </button>
  );
}
...
function Frame26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[204px] top-[261px] w-[715px]">
      <Frame25 />
      <Component31 />
    </div>
  );
...
function Component1() {
  return (
    <div className="absolute h-[772px] left-0 overflow-clip top-0 w-[1915px]" data-name="16">
      <Component2 />
      <Frame26 />
    </div>
  );
...
function Component8() {
  return (
    <div className="absolute bg-[#eaeaea] h-[763px] left-0 top-0 w-[1920px]" data-name="137">
      <RsModule />
    </div>
  );
}
...
function Section() {
  return (
    <div className="absolute bg-[#eaeaea] h-[767px] left-0 right-0 top-[69px]" data-name="Section">
      <Component8 />
    </div>
  );
}
      ...
      <div className="absolute flex inset-[60.91%_94.47%_30.17%_0] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-180 -scale-x-100 flex-none h-[100cqh] w-[100cqw]">
          <div className="relative size-full" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.8686 17.5586">
              <path d={svgPaths.p2ae1980} fill="var(--fill-0, #AAAAAA)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function HorizontalBorder() {
  return (
    <div className="absolute border-[rgba(255,255,255,0.2)] border-b border-solid h-[511px] left-0 right-0 top-0" data-name="HorizontalBorder">
      <Section1 />
      <Section2 />
      <Section3 />
      <Section4 />
...
function Footer() {
  return (
    <div className="absolute bg-[#111] h-[511px] left-[-5px] right-[-4px] top-[6420px]" data-name="Footer">
      <HorizontalBorder />
...
function Ins() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%+23.41px)] top-[102.17px] w-[43.98px]" data-name="Ins">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:ExtraBold',sans-serif] font-extrabold leading-[27px] left-[calc(50%+11.09px)] text-[18px] text-black text-center top-[-0.17px] whitespace-nowrap">S/ 248</p>
    </div>
  );
}
...
function ParagraphBackground() {
  return (
    <div className="[word-break:break-word] absolute bg-[#fef2f2] left-[72px] rounded-[5px] size-[42px] text-[#da3f3f] text-center top-[372.17px] tracking-[0.3px]" data-name="Paragraph+Background">
...
function ParagraphBackground1() {
  return (
    <div className="[word-break:break-word] absolute bg-[#fef2f2] left-[119px] rounded-[5px] size-[42px] text-[#da3f3f] text-center top-[372.17px] tracking-[0.3px]" data-name="Paragraph+Background">
...
function ParagraphBackground2() {
  return (
    <div className="[word-break:break-word] absolute bg-[#fef2f2] left-[166px] rounded-[5px] size-[42px] text-[#da3f3f] text-center top-[372.17px] tracking-[0.3px]" data-name="Paragraph+Background">
...
function ParagraphBackground3() {
  return (
    <div className="[word-break:break-word] absolute bg-[#fef2f2] left-[213px] rounded-[5px] size-[42px] text-[#da3f3f] text-center top-[372.17px] tracking-[0.3px]" data-name="Paragraph+Background">
...
function Ins1() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%+23.37px)] top-[102.17px] w-[44.14px]" data-name="Ins">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Bold',sans-serif] font-bold h-[26px] leading-[27px] left-[calc(50%+6.63px)] text-[18px] text-black text-center top-[-0.34px] w-[77px]">S/ 50</p>
    </div>
  );
}
...
function Ins2() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%+22.36px)] top-[102.17px] w-[40.33px]" data-name="Ins">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Bold',sans-serif] font-bold h-[26px] leading-[27px] left-[calc(50%+8.15px)] text-[18px] text-black text-center top-[-0.34px] w-[56px]">S/ 76</p>
    </div>
  );
}
...
function Background7() {
  return (
    <div className="absolute bg-white inset-[437px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component53 />
      <Container8 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Bold',sans-serif] font-bold h-[26px] leading-[27px] left-[calc(50%+0.5px)] text-[18px] text-black text-center top-[102.83px] w-[128px]">S/ 49 – S/ 58</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[30px] items-center p-px relative size-full">
          <Group1Of1 />
          <Group2Of1 />
          <Group3Of1 />
          <Group4Of1 />
...
function Frame28() {
  return <div className="h-[1171.94px] relative shrink-0 w-full" />;
}

function Frame29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[256px] items-start left-[-7px] top-0 w-[1407px]">
      <Container1 />
      <Frame28 />
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[35px] items-center relative shrink-0 w-[1400px]">
      <p className="[word-break:break-word] font-['Jost:Regular',sans-serif] font-normal h-[34px] leading-[34px] relative shrink-0 text-[34px] text-black text-center w-full">Ofertas especiales</p>
      <Region />
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex items-center justify-center p-[10px] relative shrink-0">
      <p className="[word-break:break-word] font-['Jost:Regular',sans-serif] font-normal leading-[34px] relative shrink-0 text-[34px] text-black text-center whitespace-nowrap">Productos Destacados</p>
    </div>
  );
}
...
function Component16() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%-0.01px)] overflow-clip top-[15px] w-[264.03px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.15px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Bufanda polar para mascota</p>
    </div>
  );
}
...
function Background8() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component16 />
      <Container10 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-1/2 text-[18px] text-black text-center top-[66px] w-[67px]">S/ 35</p>
    </div>
  );
}
...
function Component18() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%-0.01px)] overflow-clip top-[15px] w-[264.03px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.15px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Suéter tejido beige para mascota</p>
    </div>
  );
}
...
function Background9() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component18 />
      <Container12 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-1/2 text-[18px] text-black text-center top-[66px] w-[67px]">S/ 55</p>
    </div>
  );
}
...
function Component20() {
  return (
    <div className="-translate-x-1/2 absolute h-[51px] left-1/2 overflow-clip top-[15.04px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+9.65px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[282.3px]">Impermeable gris con capucha para mascota</p>
    </div>
  );
}
...
function Background10() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component20 />
      <Container14 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-1/2 text-[18px] text-black text-center top-[66.48px] w-[67px]">S/ 75</p>
    </div>
  );
}
...
function Component22() {
  return (
    <div className="-translate-x-1/2 absolute h-[51px] left-1/2 overflow-clip top-[15.04px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.67px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Chaleco acolchado azul marino para mascota</p>
    </div>
  );
}
...
function Background11() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component22 />
      <Container16 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-[calc(50%-2.31px)] text-[18px] text-black text-center top-[66.48px] w-[67px]">S/ 65</p>
    </div>
  );
}
...
function Component24() {
  return (
    <div className="-translate-x-1/2 absolute h-[47px] left-1/2 overflow-clip top-[15.07px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.67px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Botitas térmicas camel para mascota</p>
    </div>
  );
}
...
function Component26() {
  return (
    <div className="-translate-x-1/2 absolute h-[47px] left-1/2 overflow-clip top-[15.07px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[48px] leading-[23.8px] left-[calc(50%+0.67px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Gorro tejido con pompón para mascota</p>
    </div>
  );
}
...
function Background13() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component26 />
      <Container20 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-1/2 text-[18px] text-black text-center top-[66.48px] w-[67px]">S/ 40</p>
    </div>
  );
}
...
function Component28() {
  return (
    <div className="-translate-x-1/2 absolute h-[47px] left-1/2 overflow-clip top-[15.07px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.67px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Conjunto térmico crema para mascota</p>
    </div>
  );
}
...
function Background14() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component28 />
      <Container22 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-1/2 text-[18px] text-black text-center top-[61.98px] w-[67px]">S/ 70</p>
    </div>
  );
}
...
function Component30() {
  return (
    <div className="-translate-x-1/2 absolute h-[47px] left-1/2 overflow-clip top-[15.07px] w-[265px]" data-name="611">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[23.8px] left-[calc(50%+0.67px)] text-[17px] text-black text-center top-0 tracking-[0.3px] w-[264.333px]">Abrigo acolchado rosa para mascota</p>
    </div>
  );
}
...
function Background15() {
  return (
    <div className="absolute bg-white inset-[425px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component30 />
      <Container24 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[28.8px] left-[calc(50%+3.56px)] text-[18px] text-black text-center top-[59.49px] w-[67px]">S/ 85</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[1428px]">
      <Frame6 />
      <Frame7 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[35px] items-center relative shrink-0 w-[1428px]">
      <Frame24 />
      <Frame8 />
    </div>
  );
...
function Container26() {
  return (
    <div className="-translate-x-1/2 absolute h-[680px] left-1/2 top-0 w-[1430px]" data-name="Container">
      ...
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[54px] leading-[54px] left-[865px] text-[54px] text-black top-[229.83px] w-[721px]">Diseñado tus mascotas</p>
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[18px] leading-[18px] left-[865px] text-[#333] text-[18px] top-[358.83px] tracking-[0.3px] w-[455.467px]">Descubre nuestras prendas más abrigadoras para que perros y gatos disfruten del invierno con comodidad y estilo.</p>
      <Container27 />
      <Component45 />
    </div>
  );
...
function Background19() {
  return (
    <div className="-translate-x-1/2 absolute bg-white bottom-[8px] h-[45px] left-1/2 rounded-[5px] w-[178px]" data-name="Background">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[27px] left-1/2 text-[18px] text-black text-center top-[9.5px] tracking-[0.3px] w-[169.393px]">Mitones para patitas</p>
    </div>
  );
}
...
function Background20() {
  return (
    <div className="-translate-x-1/2 absolute bg-white bottom-[17px] h-[45px] left-1/2 rounded-[5px] w-[172px]" data-name="Background">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[27px] left-1/2 text-[18px] text-black text-center top-[9.5px] tracking-[0.3px] w-[163.231px]">{` Botitas de invierno`}</p>
    </div>
  );
}
...
function Component38() {
  return (
    <div className="-translate-x-1/2 absolute h-[51.19px] left-1/2 overflow-clip top-[15px] w-[252.27px]" data-name="707">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[51.19px] leading-[25.2px] left-[calc(50%+0.1px)] text-[18px] text-black text-center top-0 tracking-[0.3px] w-[252.47px]">Gorro tejido</p>
    </div>
  );
}
...
function Background21() {
  return (
    <div className="absolute bg-white inset-[437px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component38 />
      <Container39 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[27px] left-[calc(50%+0.5px)] text-[18px] text-black text-center top-[100px] w-[58px]">S/ 35</p>
    </div>
  );
}
...
function Background22() {
  return (
    <div className="absolute bg-white inset-[437px_0_0_0] rounded-bl-[4px] rounded-br-[4px]" data-name="Background">
      <Component40 />
      <Container41 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[27px] left-[calc(50%+0.1px)] text-[18px] text-black text-center top-[92.67px] w-[56px]">S/ 69</p>
    </div>
  );
}
...
function Del3() {
  return (
    <div className="-translate-x-1/2 absolute h-[47px] left-[calc(50%-30px)] opacity-50 top-[89px] w-[71px]" data-name="Del">
      <p className="-translate-x-1/2 [text-decoration-skip-ink:none] [text-underline-position:from-font] [word-break:break-word] absolute decoration-from-font decoration-solid font-['Jost:Regular',sans-serif] font-normal h-[26px] leading-[27px] left-[calc(50%+0.38px)] line-through text-[#777] text-[18px] text-center top-0 w-[41.766px]">S/90</p>
    </div>
  );
}
...
function Ins3() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%+23.21px)] top-[88.17px] w-[43.98px]" data-name="Ins">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[27px] left-[calc(50%+4.09px)] text-[18px] text-black text-center top-[-0.17px] w-[52px]">S/ 75</p>
    </div>
  );
}
    ...
    <div className="-translate-x-1/2 absolute h-[51.19px] left-[calc(50%+0.01px)] overflow-clip top-[15px] w-[256.69px]" data-name="713">
      <ul className="-translate-x-1/2 [word-break:break-word] absolute block font-['Jost:Regular',sans-serif] font-normal h-[51.19px] leading-[0] left-[calc(50%+0.1px)] text-[18px] text-black text-center top-0 tracking-[0.3px] w-[256.88px]">
        <li className="list-disc ms-[27px]">
          <span className="leading-[25.2px]">Chompa de lana</span>
        </li>
      </ul>
    </div>
  );
...
function Del4() {
  return <div className="-translate-x-1/2 absolute h-[26px] left-[calc(50%-37.83px)] opacity-50 top-[102px] w-[41.34px]" data-name="Del" />;
}

function Ins4() {
  return (
    <div className="-translate-x-1/2 absolute h-[26px] left-1/2 top-[79.67px] w-[44.14px]" data-name="Ins">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[27px] left-[calc(50%+8.13px)] text-[18px] text-black text-center top-[-0.17px] w-[60px]">S/ 55</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1406px]">
      <Frame11 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[110px] items-center left-[-3px] right-[-5px] top-0">
      <Frame27 />
      <Frame30 />
      <Section5 />
      <Frame1 />
...
function Frame3() {
  return (
    <div className="h-[4380.28px] relative shrink-0 w-full">
      <Frame2 />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute h-[75.59px] left-[67px] right-[1145.08px] top-[114.66px]" data-name="Heading 2">
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[80px] leading-[37.8px] left-0 text-[30px] text-black top-[-2.58px] w-[325px]">Prepara a tu mascota para el frío con nuestra nueva colección</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="absolute h-[75.59px] left-[782px] right-[417.92px] top-[121.23px]" data-name="Heading 2">
      <p className="[word-break:break-word] absolute font-['Jost:Regular',sans-serif] font-normal h-[80px] leading-[37.8px] left-[-24.31px] text-[30px] text-black top-[-4.41px] w-[374.417px]">Descubre las últimas tendencias en moda invernal</p>
    </div>
  );
}
...
function Component58() {
  return (
    <div className="absolute border border-black border-solid h-[46.8px] left-0 rounded-[5px] top-[220.59px] w-[130.7px]" data-name="727">
      <p className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-['Jost:Regular',sans-serif] font-normal h-[28.8px] leading-[28.8px] left-[calc(50%+0.16px)] text-[16px] text-black text-center top-[8px] tracking-[0.3px] w-[77.018px]">Ver más</p>
    </div>
  );
}
...
function Group1Of() {
  return (
    <div className="absolute bg-white h-[321.56px] left-[15px] right-[753.67px] rounded-[5px] top-0" data-name="Group - 1 of 4">
      <Container50 />
      <p className="[word-break:break-word] absolute font-['Jost:Bold',sans-serif] font-bold h-[77.37px] leading-[27.2px] left-[30px] text-[#777] text-[16px] top-[92px] tracking-[0.3px] w-[273.23px]">“Las casacas son muy cómodas y mi perrito se mantiene abrigado en los días fríos.”</p>
      <Testi1Jpg />
      <p className="[word-break:break-word] absolute capitalize font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[32.4px] left-[135.11px] text-[18px] text-black top-[208.97px] tracking-[0.3px] w-[102.97px]">Mariana R.</p>
...
function Group2Of() {
  return (
    <div className="absolute bg-white h-[321.56px] left-[384.33px] right-[384.34px] rounded-[5px] top-0" data-name="Group - 2 of 4">
      <Container52 />
      <p className="[word-break:break-word] absolute font-['Jost:SemiBold',sans-serif] font-semibold h-[77.37px] leading-[27.2px] left-[30px] text-[#777] text-[16px] top-[92px] tracking-[0.3px] w-[273.93px]">“Excelente calidad, el material es suave y el diseño le quedó perfecto a mi gato.”</p>
      <Testi2Jpg />
...
function Group3Of() {
  return (
    <div className="absolute bg-white h-[321.56px] left-[753.66px] right-[15.01px] rounded-[5px] top-0" data-name="Group - 3 of 4">
      <Container54 />
      <p className="[word-break:break-word] absolute font-['Jost:SemiBold',sans-serif] font-semibold h-[77.37px] leading-[27.2px] left-[30px] text-[#777] text-[16px] top-[92px] tracking-[0.3px] w-[264.71px]">“Las botitas resistieron muy bien las caminatas en días fríos y húmedos.”</p>
      <Testi3Jpg />
      <p className="[word-break:break-word] absolute capitalize font-['Jost:Medium',sans-serif] font-medium h-[26px] leading-[32.4px] left-[135.11px] text-[18px] text-black top-[208.97px] tracking-[0.3px] w-[108.117px]">Valeria P.</p>
...
function Section12() {
  return (
    <div className="h-[321.56px] relative shrink-0 w-full" data-name="Section">
      ...
      <p className="[word-break:break-word] absolute font-['Jost:SemiBold',sans-serif] font-semibold h-[79px] leading-[28px] left-0 text-[#777] text-[16px] top-[110.59px] tracking-[0.3px] w-[251.51px]">Mantén a tus mascotas abrigadas, cómodas y protegidas durante este invierno.</p>
      <Component58 />
      <Region2 />
    </div>
  );
...
function Section11() {
  return (
    <div className="bg-[#f7f7f7] relative shrink-0 w-full" data-name="Section">
      <div className="content-stretch flex flex-col items-start px-[260px] py-[95px] relative size-full">
        <Section12 />
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-[989px] w-[1922px]">
      <Frame10 />
    </div>
  );
}
...
function Hombres() {
  return (
    <div className="absolute bg-white h-[6931px] left-0 right-0 top-0" data-name="hombres">
      <Section />
      <Footer />
      <Frame9 />
    </div>
...
function Frame33() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[72px] items-start pl-[37px] relative shrink-0 w-[1826px]">
      <Frame20 />
    </div>
  );
}
...
export default function MascotasPage() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative size-full" data-name="mascotas">
      <Hombres />
      <Frame33 />
    </div>
  );
