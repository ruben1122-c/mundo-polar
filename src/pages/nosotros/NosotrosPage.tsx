  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M4.16667 10H15.8333" id="Vector" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1ae0b780} id="Vector_2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <button className="bg-[#004ac6] h-[59px] relative shrink-0 w-[228px] cursor-pointer transition-transform duration-200 hover:scale-105 hover:bg-[#003da4] border-0 text-left p-0" data-name="Button">
...
function Button1() {
  return (
    <button className="relative shrink-0 cursor-pointer transition-transform duration-200 hover:scale-105 border-0 bg-transparent p-0 text-left" data-name="Button">
      <div aria-hidden className="absolute border-3 border-[rgba(255,255,255,0.81)] border-solid inset-0" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[43px] py-[19px] relative size-full hover:bg-white/10 transition-colors duration-200">
        <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[0.6px] uppercase whitespace-nowrap">
...
function Button2() {
  return (
    <button className="relative shrink-0 cursor-pointer transition-transform duration-200 hover:scale-105 border-0 bg-transparent p-0 text-[#0a0a0a] hover:text-white group text-left" data-name="Button">
      <div aria-hidden className="absolute border-[0.8px] border-black border-solid inset-0 transition-colors duration-200 group-hover:bg-black" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[36.8px] py-[14.8px] relative size-full">
        <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] font-medium leading-[19.5px] relative shrink-0 text-center tracking-[1.5px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>{`Conoce más `}</p>
        <Icon1 />
      </div>
    </button>
  );
...
function Button3() {
  return (
    <button className="relative self-stretch shrink-0 cursor-pointer transition-transform duration-200 hover:scale-102 border-0 bg-transparent p-0 text-[#0a0a0a] hover:text-white group text-left" data-name="Button">
      <div aria-hidden className="absolute border-[0.8px] border-black border-solid inset-0 transition-colors duration-200 group-hover:bg-black" />
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[48.8px] py-[16.8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center tracking-[0.6px] uppercase whitespace-nowrap">{`Ver todas las reseñas `}</p>
          <Icon31 />
        </div>
      </div>
    </button>
...
function Frame12() {
  return (
    <div className="relative shrink-0 w-[1920px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[35px] items-start pt-[35px] relative w-full h-auto">
        <QuienesSomos />
        <PorQueElegirnos />
        <MisionValores />
        <EcoMateriales />
...
function CrearSeccionNosotros() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Crear sección 'Nosotros'">
      <Frame17 />
      <Body />
      <Frame12 />
      <ContactSection />
